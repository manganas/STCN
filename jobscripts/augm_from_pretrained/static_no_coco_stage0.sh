...
save_model_path="/work3/s220493/saves/from_pretrained/static_no_coco"
exp_name="davis-$davis_part-all-static-no-coco"
# load_network="/work3/s220493/saves/STCN_stage0.pth"
load_model="/work3/s220493/saves/from_pretrained/static_no_coco/checkpoint_davis-1-all-static-no-coco_checkpoint.pth"
